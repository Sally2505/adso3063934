        ...
        >
            ...
            >
                ...
                <figure className="relative flex aspect-[3/4] w-full items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,rgba(237,83,234,0.18),transparent_58%),linear-gradient(180deg,rgba(9,11,24,0.98),rgba(25,15,41,0.92))] p-3">
                    ...
                    />
                    <div className="pointer-events-none absolute top-3 right-3 z-30 rounded-full border border-primary/40 bg-black/80 px-3 py-1 text-xs font-semibold text-primary shadow-[0_12px_28px_rgba(0,0,0,0.45)] backdrop-blur-md [transform:translateZ(72px)]">
                        ${game.price}
                    </div>
                </figure>
